...
class VisitorConfirmDialog(activityContext: Context, private val bitmap: Bitmap) : Dialog(activityContext) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.dialog_confirm_visitor)
        ...
        findViewById<Button>(R.id.bt_add).setOnClickListener {
            ...
            info = findViewById<EditText>(R.id.et_info).text.toString()
            dismiss()
        }
